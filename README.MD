...
If you (the developer) privide the client application any information that can result in the collection of personal identifiable information, note that you must inform the users of your server(s).
